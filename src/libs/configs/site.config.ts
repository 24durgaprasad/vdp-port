export const siteConfig = {
  profile: {
    ...
    about:
      'Hi, I’m a Web Developer from India, currently building full-stack applications with React and Node.js. I’m passionate about clean UI, efficient backend APIs, and always learning — from DSA to DevOps.',
